    ...
    <footer className="bg-slate-950/80 border-t border-white/5 text-slate-400 py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="max-w-md mb-10 text-sm leading-relaxed font-light">
              Compromisso inabalável com a excelência jurídica entre
              continentes. Credenciado Certising e especializado em Direito
              Internacional e Imobiliário.
            </p>
            ...
            <div className="flex gap-6">
              <a
                href="https://www.instagram.com/lincolnhoshino"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 glass-card rounded-full flex items-center justify-center hover:bg-[#cba246] hover:text-[#0f172a] transition-all group/icon"
              >
                <Instagram className="w-5 h-5 group-hover/icon:scale-110 transition-transform" />
              </a>
              <a
                href="https://www.linkedin.com/in/lincoln-hoshino-058338310/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 glass-card rounded-full flex items-center justify-center hover:bg-[#cba246] hover:text-[#0f172a] transition-all group/icon"
              >
          ...
          <div>
            <h4 className="text-[#cba246] font-bold mb-10 uppercase tracking-[0.4em] text-[10px]">
              Navegação
            </h4>
            ...
            <ul className="space-y-6 text-xs font-light">
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <a
                    href="mailto:lhoshino@lincolnhoshino.com.br"
                    className="hover:text-white transition-colors"
                  >
                    lhoshino@lincolnhoshino.com.br
                  </a>
                  <a
                    href="mailto:lincolnhoshino@hotmail.com"
                    className="hover:text-white transition-colors"
                  >
                    lincolnhoshino@hotmail.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <a
                    ...
                    className="hover:text-white transition-colors"
                  >
                    WhatsApp BR: +55 11 99480-1887
                  </a>
                  <a
                    href="tel:+551130905012"
                    className="hover:text-white transition-colors"
                  >
                    BR: +55 11 3090-5012
                  </a>
                  <a
                    href="https://wa.me/817010637393"
                    className="hover:text-white transition-colors"
                  >
                    WhatsApp JP: +81 70 1063-7393
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <div>
                    <span className="text-[#cba246] font-semibold block mb-1">
                      Brasil:
                    </span>
                    <span className="hover:text-white transition-colors">
                      Av. Pedroso de Morais, 103 - Pinheiros
                      <br />
                      São Paulo - SP, 05419-000
                    </span>
                  </div>
                  <div>
                    <span className="text-[#cba246] font-semibold block mb-1">
        ...
        <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 text-[10px] uppercase tracking-[0.2em] font-medium">
          <p>
            © 2026 Lincoln Hoshino. Todos os direitos reservados. Desenvolvido
            por{" "}
            <a
              href="https://u-innova.com/"
              target="_blank"
              rel="noopener noreferrer"
              className=" hover:text-[#e5c16d] transition-colors"
            >
              u-innova
            </a>
            .
          ...
          <div className="flex gap-12 text-white/30">
            <a href="#" className="hover:text-[#cba246] transition-colors">
              Privacidade
            </a>
            <a href="#" className="hover:text-[#cba246] transition-colors">
              Compliance
