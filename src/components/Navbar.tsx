    ...
    <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-700 ${
      ...
      <div className="container mx-auto px-6">
        <div className={`flex justify-between items-center transition-all duration-500 ${
          isScrolled ? 'glass-card px-8 py-3 rounded-full border border-white/5 gold-glow' : ''
        }`}>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 border border-[#cba246]/40 flex items-center justify-center font-serif text-[#cba246] text-xl font-bold rounded-sm">LH</div>
            <div className="flex flex-col leading-none">
              <span className="font-serif text-xl tracking-wide text-white font-light">Lincoln <span className="font-bold">Hoshino</span></span>
              <span className="text-[8px] tracking-[0.4em] uppercase text-[#cba246] mt-1">Advocacia Internacional</span>
            </div>
          </div>
