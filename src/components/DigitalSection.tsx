          ...
          <div className="lg:w-1/2 relative group">
            ...
            <div className="gradient-border-gold p-1 shadow-inner relative overflow-hidden">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                 ...
                 <span className="mt-4 text-[#cba246] text-[10px] uppercase font-bold tracking-[0.4em]">Autenticação Certising</span>
              </div>
            </div>
          </div>

          <div className="lg:w-1/2">
            <span className="text-[#cba246] text-[11px] font-bold uppercase tracking-[0.3em] mb-4 block italic">Inovação Notarial</span>
            ...
            <p className="text-slate-400 mb-12 text-lg leading-relaxed font-light">
              Eliminamos as barreiras geográficas. Assine escrituras, procurações e documentos corporativos com validade plena de qualquer lugar do território japonês.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6">
              {[
                ...
                <div key={i} className="flex gap-6 p-6 glass-card rounded-sm border-l-2 border-l-[#cba246]/40 hover:border-l-[#cba246] transition-all">
                  <div className="mt-1">{item.icon}</div>
                  <div>
                    <h4 className="font-bold text-white text-sm uppercase tracking-wider mb-1 font-serif">{item.title}</h4>
            ...
            <div className="mt-16 flex items-center gap-8 opacity-60">
               <div className="flex flex-col">
                  <span className="text-white font-serif text-2xl tracking-tighter italic">Certising</span>
                  <span className="text-[8px] uppercase tracking-widest text-slate-500">Credenciado Oficial</span>
               </div>
               <div className="h-10 w-px bg-white/10"></div>
               <div className="flex flex-col">
                  <span className="text-white font-bold text-xl tracking-tighter">MALTA</span>
                  <span className="text-[8px] uppercase tracking-widest text-slate-500">Strategic Partner</span>
               </div>
            </div>
          </div>
        </div>
